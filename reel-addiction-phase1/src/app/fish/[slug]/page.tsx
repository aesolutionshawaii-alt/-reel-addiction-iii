...
import { species, getSpeciesBySlug, getAllSpeciesSlugs } from '@/data/species';
import CloudinaryImage from '@/components/CloudinaryImage';
import Footer from '@/components/Footer';
import { Calendar, Ruler, Target } from 'lucide-react';

// Generate static paths for all fish species
...
export async function generateMetadata({
  ...
  return {
    title: `${fish.hawaiianName} (${fish.name}) Fishing | Reel Addiction III`,
    description: fish.metaDescription,
    openGraph: {
      title: `Catch ${fish.hawaiianName} in Hawaii | Reel Addiction III`,
      description: fish.metaDescription,
      type: 'article',
    },
  };
