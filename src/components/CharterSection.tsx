...
const charters = [
  { title: '3/4 Day', image: '/images/charter-34day.jpg', description: 'The sweet spot. Enough time to find the bite and land your trophy.', price: '$2495', position: 'left' },
  { title: 'Full Day', image: '/images/charter-fullday.jpg', description: 'Go deeper. More water, more chances, bigger fish.', price: '$2995', position: 'right' },
  { title: 'Extravaganza', image: '/images/charter-extravaganza.jpg', description: "Dawn to dusk. Fish every minute of daylight. The ultimate O'ahu fishing experience.", price: '$3300', position: 'left' },
  { title: 'Custom Trip', image: '/images/charter-custom.jpg', description: "Outer islands. Overnighters. Ash scatterings. Tell us what you need — we'll make it happen.", price: 'Call for pricing.', position: 'right' },
]
      ...
      <div className="max-w-[1322px] mx-auto">
        ...
        <div className="grid grid-cols-2 gap-[22px]">
          {charters.map((charter) => {
            ...
            const isOtherHovered = hoveredCard !== null && hoveredCard !== charter.title
            ...
            return (
              <motion.div
                ...
                initial={{ width: 650 }}
                animate={{ 
                  width: isHovered ? 900 : isOtherHovered ? 400 : 650,
                  marginLeft: charter.position === 'right' && isHovered ? -250 : 0,
                  marginRight: charter.position === 'left' && isHovered ? -250 : 0,
                }}
