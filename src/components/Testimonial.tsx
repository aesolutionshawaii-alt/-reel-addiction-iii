    ...
    <section className="bg-navy px-5 py-16 md:px-20 md:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center">
            <div className="mb-8">
              <svg width="280" height="227" viewBox="0 0 279 227" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link
              ...
              className="bg-[#c41e3a] text-white font-outfit px-8 py-4 rounded-lg hover:bg-[#a01830] transition-colors"
            >
              Read More Reviews
            </Link>
          </div>
          <div className="text-center">
            <div className="flex gap-1 mb-6 justify-center">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-8 h-8" fill="#f4c542" viewBox="0 0 24 24">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
              ))}
            </div>
            <blockquote className="text-white text-[40px] font-outfit font-normal leading-tight mb-6">
            ...
            <p className="text-white font-outfit text-[40px]">- Eric S.</p>
          </div>
        </div>
      </div>
    </section>
