...
const charters = [
  { title: '3/4 Day', image: 'images/charter-34day', video: '/videos/charter-34day-web.mp4', mobileVideo: '/videos/hls/charter-34day/playlist.m3u8', description: 'The sweet spot. Enough time to find the bite and land your trophy.', price: '$3095', position: 'left', row: 0, objectPosition: 'center' },
  { title: 'Full Day', image: 'images/charter-fullday', video: '/videos/charter-fullday-web.mp4', mobileVideo: '/videos/hls/charter-fullday/playlist.m3u8', description: 'Go deeper. More water, more chances, bigger fish.', price: '$3495', position: 'right', row: 0, objectPosition: '60% center' },
  { title: 'Extravaganza', image: 'images/charter-extravaganza', video: '/videos/charter-extravaganza-web.mp4', mobileVideo: '/videos/hls/charter-extravaganza/playlist.m3u8', description: "Dawn to dusk. Fish every minute of daylight. The ultimate O'ahu fishing experience.", price: '$3800', position: 'left', row: 1, objectPosition: 'center' },
...
export default function CharterSectionV2({ isDark = false }: { isDark?: boolean }) {
          ...
          >
            <div className="flex gap-4 pb-4 px-[calc(50vw-150px)]" style={{ width: 'max-content' }}>
              {charters.map((charter, index) => {
                ...
                const videoSrc = shouldLoadVideo ? charter.mobileVideo : ''
                return (
                  <div
                    key={charter.title}
