          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {charters.map((charter, index) => (
              <Link
                key={index}
                href={charter.href}
                className={`group relative flex flex-col overflow-hidden rounded-3xl bg-white shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${
                  charter.featured ? 'ring-2 ring-red-500' : ''
                }`}
              >
                {/* Featured Badge */}
                {charter.featured && (
              ...
              <table className="w-full min-w-[600px]">
                <thead>
                  <tr className="border-b border-gray-200 bg-[#1B3A5F] text-white">
                    <th className="px-6 py-4 text-left font-outfit text-lg font-bold">Feature</th>
                    <th className="px-6 py-4 text-center font-outfit text-lg font-bold">3/4 Day</th>
                    <th className="px-6 py-4 text-center font-outfit text-lg font-bold">Full Day</th>
                    <th className="px-6 py-4 text-center font-outfit text-lg font-bold">Extravaganza</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  <tr>
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Duration</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">5-6 hours</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">10-12 hours</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">Dark to dark</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Price</td>
                    <td className="px-6 py-4 text-center font-outfit font-bold text-gray-900">$2,495</td>
                    <td className="px-6 py-4 text-center font-outfit font-bold text-gray-900">$2,995</td>
                    <td className="px-6 py-4 text-center font-outfit font-bold text-gray-900">$3,300</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Offshore Range</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">15-25 miles</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">25-35 miles</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">40+ miles</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Catch Guarantee</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-400">—</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-400">—</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Best For</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">Visitors & families</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">Serious anglers</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">Trophy hunters</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 font-inter font-medium text-gray-900">Return Time</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">~2pm</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">~6pm</td>
                    <td className="px-6 py-4 text-center font-inter text-gray-700">After sunset</td>
                  </tr>
                </tbody>
              </table>
            </div>
