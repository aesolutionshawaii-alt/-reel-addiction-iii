              ...
              <div className="text-white">
                ...
                <div className="space-y-4 font-inter text-base leading-relaxed opacity-90">
                  ...
                  <p className="font-semibold opacity-100">
                    This is a local boy crew fishing a luxury sportfishing yacht the way they grew up commercial fishing in Hawaii. Generations of knowledge.
                  </p>
                </div>
              </div>
            </div>
    ...
    <div className="space-y-12">
      {[
        ...
        },
        {
          ...
          desc: "Back to the dock around 2-4pm depending on the bite. We clean and fillet your catch right there — you leave with coolers full of the freshest fish you've ever tasted."
        }
      ].map((item, index) => (
  ...
  {index + 1}
      ...
      <section className="relative overflow-hidden bg-[#1B3A5F] py-32">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center text-white">
          ...
          <div>
            <p className="font-outfit text-lg font-bold">Eric S.</p>
